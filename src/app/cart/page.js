        ...
        {items.length === 0 ? (
          ...
          <>
            ...
            <div className="pt-4 border-t border-slate-700 text-sm font-semibold flex flex-col gap-4">
              ...
              {/* BETAL NU KNAP */}
              <button className="w-full rounded-full border border-blue-400 px-4 py-3 text-center text-sm font-bold uppercase tracking-wide text-white-100 transition hover:bg-blue-400 hover:text-white">Betal nu</button>
            </div>
          </>
        )}
      </section>
